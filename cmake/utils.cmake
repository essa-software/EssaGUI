...
function(essautil_setup_target targetname)
    ...
    if("${CMAKE_BUILD_TYPE}" STREQUAL "Debug")
        ...
        target_link_libraries(${targetname} Tracy::TracyClient)
        # Dirty hack because OBVIOUSLY this works for me locally but not on CI.
        target_include_directories(${targetname} PUBLIC ${Essa_SOURCE_DIR}/ThirdParty/tracy/public)
    else()
