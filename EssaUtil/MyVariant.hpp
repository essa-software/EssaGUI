...
struct static_max<arg1, arg2, others...> {
    static size_t const value = (arg1 >= arg2) ? static_max<arg1, others...>::value : static_max<arg2, others...>::value;
};
...
template<typename... Types>
class MyVariant {
    static size_t const data_size = static_max<sizeof(Types)...>::value;
    static size_t const data_align = static_max<alignof(Types)...>::value;
...
public:
    ...
    template<typename T>
    MyVariant(T const& val) {
        set<T>(val);
    }

    MyVariant(MyVariant<Types...>& other)
