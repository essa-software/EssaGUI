...
#define _ESSA_ENUM_DECL(Name, ...) Name,

#define _ESSA_ENUM_DECL_WITH_VALUES(Name, Value, ...) Name = Value,
...
//    K(Name, [Value], <optional custom arguments...>)
//    K(Name, [Value], <optional custom arguments...>)
#define ESSA_ENUM(Enum, EnumMacro) enum class Enum { EnumMacro(_ESSA_ENUM_DECL) };

#define ESSA_ENUM_WITH_VALUES(Enum, EnumMacro) enum class Enum { EnumMacro(_ESSA_ENUM_DECL_WITH_VALUES) };
...
//
#define ESSA_ENUM_BITWISE_OPERATORS(Enum) _ESSA_ENUM_BITWISE_OPERATORS_INTERNAL(Enum, )

// Enables bitwise operators for the specified Enum type, this
// version is meant for use on enums which are private to the
// containing type.
//
#define ESSA_ENUM_BITWISE_FRIEND_OPERATORS(Enum) _ESSA_ENUM_BITWISE_OPERATORS_INTERNAL(Enum, friend)
