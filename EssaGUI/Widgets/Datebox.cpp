...
void Datebox::create_container() {
    ...
    right_century_arrow_btn->set_arrow_size(10.0_px);
    ...
    right_year_arrow_btn->set_arrow_size(10.0_px);
    ...
    right_month_arrow_btn->set_arrow_size(10.0_px);
...
void Datebox::update_calendar() {
    ...
    for (unsigned j = 0; j < m_calendar_contents.size(); j++) {
        ...
        if (m_date == date) {
            colors.normal.unhovered.background = Util::Colors::Blue;
