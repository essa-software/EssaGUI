...
public:
    ...
    virtual Util::Vector2f point(size_t idx) const = 0;
    ...
    class Points {
        struct PointIterator {
            ...
            Util::Vector2f operator*() const { return shape->point(index); }
            Util::Vector2f operator->() const { return shape->point(index); }
    ...
    public:
        ...
        std::vector<Util::Vector2f> to_vector() const {
            std::vector<Util::Vector2f> vector;
