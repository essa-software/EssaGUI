...
template<typename T> Widget::EventHandlerResult StateTextButton<T>::on_mouse_button_press(Event::MouseButtonPress const&) {
    m_index++;
...
template<typename T> void StateTextButton<T>::draw(Gfx::Painter& painter) const {
